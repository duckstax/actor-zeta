...
///
        ...
        struct multiplexer: public ref_counted {
            ...
            virtual void new_tcp_listener(const std::string &host, uint16_t port, actor_address ) = 0;

            virtual void new_tcp_connection(const std::string &host, uint16_t port, actor_address ) = 0;
