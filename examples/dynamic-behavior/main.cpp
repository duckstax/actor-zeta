...
public:
    ...
    worker_t(supervisor_lite* ptr)
        : actor_zeta::base::basic_actor<worker_t>(ptr)
        , download_(resource())
        , work_data_(resource()) {
        actor_zeta::base::behavior(download_,command_t::download,this, &worker_t::download);
        actor_zeta::base::behavior(work_data_,command_t::work_data,this, &worker_t::work_data);
    }
    ...
    actor_zeta::base::behavior_t make_behavior(){
        return actor_zeta::base::behavior(
            resource(),
            [](){
...
private:
    actor_zeta::base::behavior_t download_;
    actor_zeta::base::behavior_t work_data_;
    std::string tmp_;
};
...
public:
    ...
    explicit supervisor_lite(memory_resource* ptr)
        ...
        , e_(new actor_zeta::scheduler_t<actor_zeta::work_sharing>(
             ...
             thread_pool_deleter) {
        e_->start();
        ///actor_zeta::base::behavior(,system_command::create, &supervisor_lite::create);
        ///actor_zeta::base::behavior(system_command::broadcast, &supervisor_lite::broadcast_impl);
    }
