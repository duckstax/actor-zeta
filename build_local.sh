...
cmake -DCMAKE_BUILD_TYPE=Debug -DCMAKE_CXX_STANDARD=${CMAKE_CXX_STANDARD} -DALLOW_EXAMPLES=OFF -DALLOW_TESTS=ON -DENABLE_TESTS_MEASUREMENTS=OFF -DALLOW_BENCHMARK=OFF -DEXCEPTIONS_DISABLE=ON -DRTTI_DISABLE=OFF ..
cmake --build .
