...
cmake -DCMAKE_BUILD_TYPE=Debug -DCMAKE_CXX_STANDARD=${CMAKE_CXX_STANDARD} -DALLOW_EXAMPLES=OFF -DALLOW_TESTS=ON -DENABLE_TESTS_MEASUREMENTS=ON -DALLOW_BENCHMARK=ON -DEXCEPTIONS_DISABLE=ON -DRTTI_DISABLE=OFF ..
cmake --build .
